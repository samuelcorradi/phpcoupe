...
abstract class Db extends \Coupe\Model
{
	...
	* @return int|bool Quantidade de linhas atualizadas ou falso.
	*/
	...
	/**
	* Insere um novo registro e retorna
	* o ID (caso use AUTO_INCREMENT).
	*/
	...
	/**
	* Deleta todos registros da tabela ou
	* somente os selecionadas pelo filtro.
	*/
	...
	*/
	...
	// ok
	public function find($value, Array $order=NULL, $recursion=NULL)
	{

		return $this->findBy($this->primary, $value, $order, $recursion, NULL);
	
	}

	public function findBy($field, $value, $order=array(), $recursion=NULL, $pagesize=NULL)
	{

		if ( isset($this->schema[ $field ]) )
		{
			return $this->getAll(array($field=>$value), $order, $recursion, $pagesize);
		}
