...
namespace Habilis
{
	...
	class Url
	{
		...
		*/
		...
		/**
		* Retorna a URL atual acessada pelo cliente da aplicação WEB.
		*
		* @access public
		...
		*/
		public static function current()
		{
			...
			$path = ( isset($_SERVER['REQUEST_URI']) ) ? $_SERVER['REQUEST_URI'] : ''; // TODO: Ver a possibilidade de pegar o caminho, mas também o caminho para script atual.
		...
		*/
		...
		// TODO: criar as validações para as partes da URL
		...
		public function validatePath($path=NULL)
		{
			...
			if( ! is_array($path) )
			{
				$path = explode("/", trim($path, "/")); // TODO: o trim trata a questão do path começar com uma barra.
			}
